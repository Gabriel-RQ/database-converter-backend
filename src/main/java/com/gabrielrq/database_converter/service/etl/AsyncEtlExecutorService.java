...
public class AsyncEtlExecutorService {
    ...
    public AsyncEtlExecutorService(DataExtractionService extractionService, DataTransformationService transformationService, DataLoadingService loadingService, EtlStatusRepository statusRepository) {
